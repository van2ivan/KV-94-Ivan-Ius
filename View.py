...
class View:
    ...
    def output(self):
        ...
        if self.table == 1:
            ...
            for column in self.datas:
               print("{:<9}{:<15}{}".format(column.id, column.name, column.marksid))
            print("***************************\n")
        elif self.table == 2:
            print('id       Name      Surname')
            for column in self.datas:
                print("{:<9}{:<10}{}".format(column.id, column.name, column.surname))
            print("***************************\n")
        elif self.table == 3:
            print('id       Name     Patronymic      Surname')
            for column in self.datas:
                print("{:<9}{:<9}{:16}{}".format(column.Id, column.Name, column.Patronymic,column.Surname))
            print("***************************\n")
        elif self.table == 4:
            print('id       time                      pupilsID      teachersID')
            for column in self.datas:
              print("{:<9}{:<26}{:<14}{}".format(column.id, str(column.time), column.pupilsid, column.teachersid))
            print("***************************\n")

        elif self.table == 5:
            print('id       pupilsID     subjectID')
            for column in self.datas:
                print("{:<9}{:<13}{}".format(column.id, column.pupilsid, column.subjectsid))
            print("***************************\n")
        elif self.table == 6:
            print('id       teachersID     subjectsID')
            for column in self.datas:
              print("{:<9}{:<15}{}".format(column.id, column.teachersid, column.subjectsid))
            print("***************************\n")
